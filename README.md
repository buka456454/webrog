...
- **⚔️ Подбор оружия**: Нажмите `E` рядом с оружием
- **🗡️ Атака**: Левый клик мыши (если есть оружие)
- **💬 Чат**: Введите сообщение и нажмите Enter

### Типы оружия
- **🗡️ Нож**: Урон 1, радиус 50, прочность 2
- **⚔️ Меч**: Урон 2, радиус 80, прочность 3  
- **🛡️ Двуручный меч**: Урон 4, радиус 110, прочность 5
...
- **Урон**: От 1 до 4 единиц в зависимости от оружия
- **Дальность**: От 50 до 110 пикселей
...
### Настройки оружия
```javascript
knife: { damage: 1, range: 50, durability: 2 }
sword: { damage: 2, range: 80, durability: 3 }
greatsword: { damage: 4, range: 110, durability: 5 }
```
